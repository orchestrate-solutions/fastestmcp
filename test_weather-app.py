"""
Tests for weather-app MCP Server
...
def load_server_module():
    ...
    spec = importlib.util.spec_from_file_location("weather_app", "weather-app.py")
...
class TestWeatherappServer:
    """Test cases for the weather-app MCP server"""

    def test_server_creation(self):
        """Test that the MCP server is created successfully"""
        assert app is not None
        assert hasattr(app, 'name')
        assert "weather-app" in app.name
